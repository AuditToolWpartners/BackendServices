    ...
    const handleSave = () => {
        const scores = {
            ...
            "governance": {
                ...
                "systemsDataScore": api.systemsDataScore,
                "systemsData": api.systemsData,
                "obsoleteUserScore": api.obsoleteUserScore,
                "obsoleteUser": api.obsoleteUser,
            },
            "riskManagement": {
            ...
            "policy": {
                ...
                "complexityReqPassScore": api.complexityReqPassScore,
                "complexityReqPass": api.complexityReqPass,
                "complexReqAdminPassScore": api.complexReqAdminPassScore,
                "complexReqAdminPass": api.complexReqAdminPass,
                "onBoardingStaffScore": api.onBoardingStaffScore,
                "onBoardingStaff": api.onBoardingStaff,
                "offBoardingStaffScore": api.offBoardingStaffScore,
                "offBoardingStaff": api.offBoardingStaff,
            },
            "training": {
                "totalScoreAvailable": 11,
                "staffTrainingScore": api.staffTrainingScore,
                "staffTraining": api.staffTraining,
                "staffTrainingUpdatesScore": api.staffTrainingUpdatesScore,
                "staffTrainingUpdates": api.staffTrainingUpdates,
                "phishingTrainingScore": api.phishingTrainingScore,
                "phishingTraining": api.phishingTraining,
                "passwordTrainingScore": api.passwordTrainingScore,
                "passwordTraining": api.passwordTraining,
                "secureWorkingTrainingScore": api.secureWorkingTrainingScore,
                "secureWorkingTraining": api.secureWorkingTraining,
                "protectionTrainingScore": api.protectionTrainingScore,
                "protectionTraining": api.protectionTraining,
                "securityIncidentTrainingScore": api.securityIncidentTrainingScore,
                "securityIncidentTraining": api.securityIncidentTraining,
                "emailTrainingScore": api.emailTrainingScore,
                "emailTraining": api.emailTraining,
                "socialMediaTrainingScore": api.socialMediaTrainingScore,
                "socialMediaTraining": api.socialMediaTraining,
                "secAwareScore": api.secAwareScore,
                "secAware": api.secAware,
                "regTrainingScore": api.regTrainingScore,
                "regTraining": api.regTraining,
            },
            "IAM": {
                "totalScoreAvailable": 7,
                "dataRestrictionScore": api.dataRestrictionScore,
                "dataRestriction": api.dataRestriction,
                "confidentialInfoScore": api.confidentialInfoScore,
                "confidentialInfo": api.confidentialInfo,
                "administratorAccessScore": api.administratorAccessScore,
                "administratorAccess": api.administratorAccess,
                "limitAdminAccessScore": api.limitAdminAccessScore,
                "limitAdminAccess": api.limitAdminAccessScore,
                "adminRestrictionScore": api.adminRestrictionScore,
                "adminRestriction": api.adminRestriction,
                "generateAlertsScore": api.generateAlertsScore,
                "generateAlerts": api.generateAlerts,
                "passwordManagementScore": api.passwordManagementScore,
                "passwordManagement": api.passwordManagement,
            }
